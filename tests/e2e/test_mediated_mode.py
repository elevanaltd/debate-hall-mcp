...
async def test_mediated_mode_with_pick(cleanup_debates):  # noqa: ARG001
    ...
    async with create_connected_server_and_client_session(server) as client_session:
        ...
        pick_wind_text = pick_wind_result.content[0].text if hasattr(pick_wind_result.content[0], 'text') else str(pick_wind_result.content[0])
        ...
        pick_door_text = pick_door_result.content[0].text if hasattr(pick_door_result.content[0], 'text') else str(pick_door_result.content[0])
