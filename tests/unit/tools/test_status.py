...
def test_debate_status_new_debate(tmp_path: Path) -> None:
    ...
    result = debate_status(thread_id="2025-01-01-test-thread-001", state_dir=tmp_path)
...
def test_debate_status_with_turns(tmp_path: Path) -> None:
    ...
    debate_turn("2025-01-01-test-thread-002", "Wind", "W1", state_dir=tmp_path)
    debate_turn("2025-01-01-test-thread-002", "Wall", "W2", state_dir=tmp_path)

    result = debate_status(thread_id="2025-01-01-test-thread-002", state_dir=tmp_path)
...
def test_debate_status_closed_debate(tmp_path: Path) -> None:
    ...
    result = debate_status(thread_id="2025-01-01-test-thread-003", state_dir=tmp_path)
...
def test_debate_status_includes_synthesis_if_present(tmp_path: Path) -> None:
    ...
    result = debate_status(thread_id="2025-01-01-test-thread-004", state_dir=tmp_path)
...
def test_debate_status_mediated_mode(tmp_path: Path) -> None:
    ...
    result = debate_status(thread_id="2025-01-01-test-thread-005", state_dir=tmp_path)
